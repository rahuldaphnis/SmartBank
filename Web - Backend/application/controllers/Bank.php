...
class Bank extends CI_Controller {
	...
	public function getSavedBanks() {
		...
		foreach ($records as $r) {
			$records1 = $this->bankmodel->getBankThreshold($r->bankid);
			$r->bankname = $records1->name;
			$r->bankthreshold = $records1->threshold;
		}
			$result['success'] = '1';
			$result['data'] = $records;
		}
	...
	public function addAccount() {
		...
		$url = 'https://rahuldaphnis96.000webhostapp.com/SmartBank/SmartBank/index.php/BankDryApi/getData';
		$curl = curl_init($url);
